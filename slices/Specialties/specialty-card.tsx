...
import type { KeyTextField, ImageField, LinkField } from "@prismicio/client";
import gsap from "gsap";

interface SpecialtyCardItem {
  title: KeyTextField;
  description: KeyTextField;
  image: ImageField<"card">;
  link: LinkField;
}

interface SpecialtyCardProps {
  item: SpecialtyCardItem;
  index: number;
}

export default function SpecialtyCard({ item, index }: SpecialtyCardProps) {
