...
export interface HomepageHeroSliceDefaultPrimary {
  ...
  /**
   * Background Image (Optional) field in *HomepageHero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
  ...
  /**
   * Content Alignment field in *HomepageHero → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: Choose alignment
   * - **Default Value**: left
   * - **API ID Path**: homepage_hero.default.primary.content_alignment
   * - **Documentation**: https://prismic.io/docs/fields/select
   */
